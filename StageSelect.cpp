...
static char* g_StageSelect2TextureName = (char*)"data\\texture\\15.png";	//テクスチャファイルパス
...
static ID3D11ShaderResourceView* g_StageSelectTextureNumber;	//画像一枚で一つの変数が必要
...
HRESULT InitStageSelect() {
	...
	if (OneFlag)
	{
		for (int i = 0; i < STAGE_MAX; i++)
		{
			...
			g_StageSelectNumber[i].StageUseFlag = false;		
